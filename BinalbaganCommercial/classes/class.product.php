  ...
  class Product{
    ...
    public function updateProductStock($id,$level,$curr,$empid){
      $sql = "UPDATE tbl_product SET
      prd_level = '$level'
      WHERE prd_id = '$id'";
      $result = mysqli_query($this->db,$sql) or die(mysqli_error() . "CLASS ERROR");

      $sql = "INSERT INTO tbl_update_log(prd_id,log_qty,log_datestamp,log_timestamp,emp_id)
        VALUES('$id','$curr',NOW(),NOW(),$empid)";
