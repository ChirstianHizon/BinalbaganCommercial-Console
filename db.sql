...
CREATE TABLE IF NOT EXISTS `tbl_delivery` (
  ...
  KEY `add_id` (`add_id`)
) ENGINE=InnoDB AUTO_INCREMENT=14000032 DEFAULT CHARSET=latin1 COMMENT='1    -> READY FOR DELIVERY\r\n200 - > COMPLETED\r\n';

-- Dumping data for table db_binalbagancommercial.tbl_delivery: ~27 rows (approximately)
...
INSERT INTO `tbl_delivery` (`del_id`, `del_start_datestamp`, `del_end_datestamp`, `del_status`, `order_id`, `add_id`) VALUES
	...
	(3, '2017-10-05 02:47:08', NULL, 200, 2, 0),
	(4, '2017-10-16 11:57:52', NULL, 200, 6, 0),
	...
	(14000005, '2017-10-23 11:16:01', NULL, 200, 9000012, 0),
	...
	(14000010, '2017-10-24 15:54:01', '2017-11-13 02:20:00', 200, 9000018, 0),
	(14000011, '2017-11-11 18:44:51', NULL, 200, 9000017, 0),
	(14000014, '2017-11-12 00:30:23', '2017-11-13 02:29:21', 200, 9000014, 0),
	(14000017, '2017-11-12 21:36:08', '2017-11-13 02:15:25', 200, 9000021, 0),
	(14000018, '2017-11-13 02:27:40', '2017-11-13 02:28:28', 200, 9000020, 0),
	(14000021, '2017-11-13 02:46:40', '2017-11-13 02:50:16', 200, 9000022, 0),
	(14000024, '2017-11-13 03:09:59', '2017-11-13 03:34:14', 200, 9000023, 0),
	(14000025, '2017-11-13 03:21:19', '2017-11-13 03:34:14', 200, 9000023, 0),
	(14000026, '2017-11-13 10:03:18', '2017-11-13 10:07:20', 200, 9000024, 0),
	(14000027, '2017-11-14 00:10:11', '2017-11-14 00:17:56', 200, 9000025, 0),
	(14000028, '2017-11-14 00:27:46', '2017-11-14 00:29:01', 200, 9000026, 0),
	(14000029, '2017-11-14 13:36:05', '2017-11-14 13:37:22', 200, 9000027, 0),
	(14000030, '2017-11-14 13:41:48', '2017-11-14 13:45:51', 200, 9000028, 0),
	(14000031, '2017-11-14 14:20:01', '2017-11-14 14:20:52', 200, 9000029, 0);
...
CREATE TABLE IF NOT EXISTS `tbl_order` (
  ...
  KEY `user_id` (`cust_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9000030 DEFAULT CHARSET=latin1 COMMENT='order_type\r\n-----------------------------------\r\n0 -> PICK - UP \r\n1 -> DELIVERY\r\n\r\norder_status\r\n-----------------------------------\r\n0 -> PENDING\r\n1 -> APPROVED\r\n2 -> DECLINED\r\n100 -> COMPLETED\r\n200 -> ON DELIVERY\r\n300 -> REVISED\r\n\r\n';

-- Dumping data for table db_binalbagancommercial.tbl_order: ~41 rows (approximately)
...
INSERT INTO `tbl_order` (`order_id`, `order_datestamp`, `order_timestamp`, `cust_id`, `order_status`, `order_type`, `receive_datestamp`, `order_note`, `order_address`) VALUES
	...
	(9000018, '2017-10-23', '11:30:48', 110000011, 100, 1, '2017-10-23', '', '146 Burgos Extension Talisay City'),
	(9000019, '2017-10-23', '12:00:34', 110000011, 0, 0, '0000-00-00', '', 'N/A'),
	(9000020, '2017-10-23', '14:31:23', 110000011, 100, 1, '2017-11-13', '', '146 Burgos Extension Talisay City'),
	(9000021, '2017-11-11', '18:35:42', 110000011, 100, 1, '2017-11-11', '', '146 Burgos Extension Talisay City'),
	(9000022, '2017-11-13', '02:46:01', 110000011, 100, 1, '2017-11-13', '', '146 Burgos Extension Talisay City'),
	(9000023, '2017-11-13', '02:53:28', 110000011, 100, 1, '2017-11-13', '', '146 Burgos Extension Talisay City'),
	(9000024, '2017-11-13', '10:02:54', 110000011, 100, 1, '2017-11-13', '', '146 Burgos Extension Talisay City'),
	(9000025, '2017-11-13', '10:09:02', 110000011, 100, 1, '2017-11-13', '', '146 Burgos Extension Talisay City'),
	(9000026, '2017-11-14', '00:27:31', 110000011, 100, 1, '2017-11-14', '', '146 Burgos Extension Talisay City'),
	(9000027, '2017-11-14', '13:34:55', 110000011, 100, 1, '2017-11-14', '', '146 Burgos Extension Talisay City'),
	(9000028, '2017-11-14', '13:41:06', 110000011, 100, 1, '2017-11-14', '', '146 Burgos Extension Talisay City'),
	(9000029, '2017-11-14', '14:19:07', 110000011, 100, 1, '2017-11-14', '', '146 Burgos Extension Talisay City');
...
CREATE TABLE IF NOT EXISTS `tbl_order_list` (
  ...
  KEY `prd_id` (`prd_id`),
  KEY `order_id` (`order_id`)
) ENGINE=InnoDB AUTO_INCREMENT=15000045 DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_order_list` (`order_list_id`, `prd_id`, `prd_qty`, `order_id`, `prd_price`) VALUES
	...
	(15000036, 16000002, 20, 9000021, 300.45),
	(15000037, 16000002, 20, 9000022, 300.45),
	(15000038, 16000002, 20, 9000023, 300.45),
	(15000039, 16000002, 20, 9000024, 300.45),
	(15000040, 16000002, 20, 9000025, 300.45),
	(15000041, 16000002, 20, 9000026, 300.45),
	(15000042, 16000002, 20, 9000027, 300.45),
	(15000043, 16000001, 35, 9000028, 160.53),
	(15000044, 16000001, 35, 9000029, 160.53);
...
INSERT INTO `tbl_product` (`prd_id`, `prd_name`, `prd_desc`, `prd_price`, `prd_datestamp`, `prd_timestamp`, `prd_status`, `prd_level`, `prd_optimal`, `prd_warning`, `prd_image`, `cat_id`) VALUES
	...
	(16000000, 'Thunderbird Forest 3/4in x 2 ft x 4', 'Product Thickness: 0.75 in.\nProduct Width: 2 ft.\nProduct Length: 4 ft.\nPlywood Type: Plywood', 278.55, '2017-10-23', '08:19:16', 1, -32, 50, 10, 'https://firebasestorage.googleapis.com/v0/b/binalbagancommercial-229c0.appspot.com/o/products%2FpACE3-1046484enh-z7.jpgThunderbird%20Forest%203%2F4in%20x%202%20ft%20x%204?alt=media&token=5c204d85-a576-44d5-8511-6ffe95e46daa', 13000000),
	(16000001, 'Thunderbird Forest 2in x 6in x 8 ft', 'Wood Type: Wood\nProduct Type: Lumber\nLumber Thickness: 2 in.\nLumber Width: 6 in.\nLumber Length: 8 ft.', 160.53, '2017-10-23', '08:23:45', 1, 185, 30, 10, 'https://firebasestorage.googleapis.com/v0/b/binalbagancommercial-229c0.appspot.com/o/products%2FpACE3-17521058enh-z7.jpgThunderbird%20Forest%202in%20x%206in%20x%208%20ft?alt=media&token=c873c99c-3fcb-4222-a4a0-70232a027d3d', 13000000),
	(16000002, 'Thunderbird Pine Forest 3/4in x 2 ft x 4', 'Product Thickness: 0.75 in.\nProduct Width: 2 ft.\nProduct Length: 4 ft.', 300.45, '2017-10-23', '08:25:32', 1, 80, 30, 5, 'https://firebasestorage.googleapis.com/v0/b/binalbagancommercial-229c0.appspot.com/o/products%2FThunderbird%20Forest.jpgThunderbird%20Pine%20Forest%203%2F4in%20x%202%20ft%20x%204?alt=media&token=b0cf1210-2779-4d31-9aed-5e776ba51c35', 13000000),
	(16000003, 'Thunderbird Forest - Treated Fence Stud 4in x 4in x 8 ft', 'Wood Type: Pine\nProduct Type: Post\nLumber Thickness: 4 in.\nLumber Width: 4 in.\nLumber Length: 8 ft.', 84.99, '2017-10-23', '08:26:41', 1, 358, 30, 20, 'https://firebasestorage.googleapis.com/v0/b/binalbagancommercial-229c0.appspot.com/o/products%2FpACE3-17521061enh-z7.jpgThunderbird%20Forest%20-%20Treated%20Fence%20Stud%204in%20x%204in%20x%208%20ft?alt=media&token=aae2f490-0816-41f4-8b71-45d24a5e7d0f', 13000000);
...
CREATE TABLE IF NOT EXISTS `tbl_product_log` (
  ...
  KEY `sup_id` (`sup_id`)
) ENGINE=InnoDB AUTO_INCREMENT=17000091 DEFAULT CHARSET=latin1;

-- Dumping data for table db_binalbagancommercial.tbl_product_log: ~113 rows (approximately)
...
INSERT INTO `tbl_product_log` (`log_id`, `prd_id`, `log_qty`, `log_datestamp`, `log_timestamp`, `emp_id`, `log_type`, `sales_id`, `sup_id`, `supp_price`) VALUES
	...
	(17000056, 16000000, 20, '2017-10-24', '16:05:20', 0, 1, 19000026, 0, 0.00),
	(17000057, 16000000, 20, '2017-10-24', '16:05:20', 0, 1, 19000028, 0, 0.00),
	(17000058, 16000000, 20, '2017-10-24', '16:05:21', 0, 1, 19000029, 0, 0.00),
	(17000059, 16000000, 20, '2017-10-24', '16:05:21', 0, 1, 19000025, 0, 0.00),
	(17000060, 16000000, 20, '2017-10-24', '16:05:21', 0, 1, 19000032, 0, 0.00),
	(17000061, 16000000, 20, '2017-10-24', '16:05:21', 0, 1, 19000027, 0, 0.00),
	(17000062, 16000000, 20, '2017-10-24', '16:05:21', 0, 1, 19000031, 0, 0.00),
	(17000063, 16000000, 20, '2017-10-24', '16:05:21', 0, 1, 19000030, 0, 0.00),
	(17000064, 16000000, 20, '2017-10-24', '16:05:21', 0, 1, 19000033, 0, 0.00),
	(17000065, 16000000, 20, '2017-10-24', '16:05:21', 0, 1, 19000034, 0, 0.00),
	(17000066, 16000000, 20, '2017-10-24', '16:05:23', 0, 1, 19000035, 0, 0.00),
	(17000067, 16000000, 20, '2017-10-24', '16:05:23', 0, 1, 19000038, 0, 0.00),
	(17000068, 16000000, 20, '2017-10-24', '16:05:23', 0, 1, 19000036, 0, 0.00),
	(17000069, 16000000, 20, '2017-10-24', '16:05:23', 0, 1, 19000037, 0, 0.00),
	(17000070, 16000000, 20, '2017-10-24', '16:05:23', 0, 1, 19000039, 0, 0.00),
	(17000071, 16000000, 20, '2017-10-24', '16:05:23', 0, 1, 19000040, 0, 0.00),
	(17000072, 6, 4, '2017-11-06', '14:23:54', 80000002, 1, 19000041, 0, 0.00),
	(17000073, 16000003, 2, '2017-11-06', '14:23:54', 80000002, 1, 19000041, 0, 0.00),
	(17000074, 16000002, 20, '2017-11-13', '02:15:25', 0, 1, 19000042, 0, 0.00),
	(17000075, 16000000, 20, '2017-11-13', '02:20:01', 0, 1, 19000043, 0, 0.00),
	(17000076, 16000001, 20, '2017-11-13', '02:28:28', 0, 1, 19000044, 0, 0.00),
	(17000077, 16000002, 20, '2017-11-13', '02:28:28', 0, 1, 19000044, 0, 0.00),
	(17000078, 16000000, 20, '2017-11-13', '02:29:11', 0, 1, 19000045, 0, 0.00),
	(17000079, 16000003, 20, '2017-11-13', '02:29:21', 0, 1, 19000046, 0, 0.00),
	(17000080, 16000001, 20, '2017-11-13', '02:29:21', 0, 1, 19000046, 0, 0.00),
	(17000081, 16000002, 5, '2017-11-13', '02:29:22', 0, 1, 19000046, 0, 0.00),
	(17000082, 16000002, 20, '2017-11-13', '02:50:17', 0, 1, 19000047, 0, 0.00),
	(17000083, 16000002, 20, '2017-11-13', '03:34:12', 0, 1, 19000048, 0, 0.00),
	(17000084, 16000002, 20, '2017-11-13', '03:34:14', 0, 1, 19000049, 0, 0.00),
	(17000085, 16000002, 20, '2017-11-13', '10:07:20', 0, 1, 19000050, 0, 0.00),
	(17000086, 16000002, 20, '2017-11-14', '00:17:56', 0, 1, 19000051, 0, 0.00),
	(17000087, 16000002, 20, '2017-11-14', '00:29:02', 0, 1, 19000052, 0, 0.00),
	(17000088, 16000002, 20, '2017-11-14', '13:37:22', 0, 1, 19000053, 0, 0.00),
	(17000089, 16000001, 35, '2017-11-14', '13:45:51', 0, 1, 19000054, 0, 0.00),
	(17000090, 16000001, 35, '2017-11-14', '14:20:52', 0, 1, 19000055, 0, 0.00);
...
CREATE TABLE IF NOT EXISTS `tbl_route` (
  ...
  KEY `del_id` (`del_id`)
) ENGINE=InnoDB AUTO_INCREMENT=18000454 DEFAULT CHARSET=latin1;

-- Dumping data for table db_binalbagancommercial.tbl_route: ~580 rows (approximately)
...
INSERT INTO `tbl_route` (`route_id`, `route_lat`, `route_lng`, `route_datestamp`, `del_id`) VALUES
	...
	(18000152, '10.67789', '122.9624', '2017-10-24 15:56:05', 14000010),
	(18000153, '10.67789', '122.9624', '2017-10-24 15:56:05', 14000010),
	(18000154, '10.67789', '122.9624', '2017-10-24 15:56:05', 14000010),
	(18000155, '10.67789', '122.9624', '2017-10-24 15:56:05', 14000010),
	(18000156, '10.67789', '122.9624', '2017-10-24 15:56:05', 14000010),
	(18000157, '10.67789', '122.9624', '2017-10-24 15:56:05', 14000010),
	(18000158, '10.67789', '122.9624', '2017-10-24 15:56:05', 14000010),
	(18000159, '10.67789', '122.9624', '2017-10-24 15:56:05', 14000010),
	(18000160, '10.67789', '122.9624', '2017-10-24 15:56:05', 14000010),
	(18000161, '10.67764', '122.9629', '2017-10-24 15:57:07', 14000010),
	(18000162, '10.67764', '122.9629', '2017-10-24 15:57:07', 14000010),
	(18000163, '10.67764', '122.9629', '2017-10-24 15:57:07', 14000010),
	(18000164, '10.67764', '122.9629', '2017-10-24 15:57:07', 14000010),
	(18000165, '10.67764', '122.9629', '2017-10-24 15:57:07', 14000010),
	(18000166, '10.67876', '122.9625', '2017-10-24 15:58:27', 14000010),
	(18000167, '10.67876', '122.9625', '2017-10-24 15:58:27', 14000010),
	(18000168, '10.67876', '122.9625', '2017-10-24 15:58:27', 14000010),
	(18000169, '10.67764', '122.9629', '2017-10-24 15:57:07', 14000010),
	(18000170, '10.67764', '122.9629', '2017-10-24 15:57:07', 14000010),
	(18000171, '10.67764', '122.9629', '2017-10-24 15:57:07', 14000010),
	(18000172, '10.67876', '122.9625', '2017-10-24 15:58:27', 14000010),
	(18000173, '10.67876', '122.9625', '2017-10-24 15:58:27', 14000010),
	(18000174, '10.67876', '122.9625', '2017-10-24 15:58:27', 14000010),
	(18000175, '10.67876', '122.9625', '2017-10-24 15:58:27', 14000010),
	(18000176, '10.67764', '122.9629', '2017-10-24 15:57:07', 14000010),
	(18000177, '10.67876', '122.9625', '2017-10-24 15:58:27', 14000010),
	(18000178, '10.67876', '122.9625', '2017-10-24 15:58:27', 14000010),
	(18000179, '10.67789', '122.9624', '2017-10-24 15:56:05', 14000010),
	(18000180, '10.67764', '122.9629', '2017-10-24 15:57:07', 14000010),
	(18000181, '10.67876', '122.9625', '2017-10-24 15:58:27', 14000010),
	(18000182, '10.67789', '122.9624', '2017-10-24 15:56:05', 14000010),
	(18000183, '10.67789', '122.9624', '2017-10-24 15:56:05', 14000010),
	(18000184, '10.67789', '122.9624', '2017-10-24 15:56:05', 14000010),
	(18000185, '10.67789', '122.9624', '2017-10-24 15:56:05', 14000010),
	(18000186, '10.67789', '122.9624', '2017-10-24 15:56:05', 14000010),
	(18000187, '10.67789', '122.9624', '2017-10-24 15:56:05', 14000010),
	(18000188, '10.67764', '122.9629', '2017-10-24 15:57:07', 14000010),
	(18000189, '10.67764', '122.9629', '2017-10-24 15:57:07', 14000010),
	(18000190, '10.67876', '122.9625', '2017-10-24 15:58:27', 14000010),
	(18000191, '10.67764', '122.9629', '2017-10-24 15:57:07', 14000010),
	(18000192, '10.67764', '122.9629', '2017-10-24 15:57:07', 14000010),
	(18000193, '10.67764', '122.9629', '2017-10-24 15:57:07', 14000010),
	(18000194, '10.67764', '122.9629', '2017-10-24 15:57:07', 14000010),
	(18000195, '10.67876', '122.9625', '2017-10-24 15:58:27', 14000010),
	(18000196, '10.67876', '122.9625', '2017-10-24 15:58:27', 14000010),
	(18000197, '10.67876', '122.9625', '2017-10-24 15:58:27', 14000010),
	(18000198, '10.67876', '122.9625', '2017-10-24 15:58:27', 14000010),
	(18
	(18000400, '10.74034', '122.9651', '2017-11-13 03:30:05', 14000024),
	(18000401, '10.74034', '122.9651', '2017-11-13 03:30:25', 14000024),
	(18000402, '10.74034', '122.9651', '2017-11-13 03:30:45', 14000024),
	(18000403, '10.74034', '122.9651', '2017-11-13 03:31:05', 14000024),
	(18000404, '10.74034', '122.9651', '2017-11-13 03:31:26', 14000024),
	(18000405, '10.74034', '122.9651', '2017-11-13 03:31:46', 14000024),
	(18000406, '10.74034', '122.9651', '2017-11-13 03:32:06', 14000024),
	(18000407, '10.74034', '122.9651', '2017-11-13 03:32:26', 14000024),
	(18000408, '10.74034', '122.9651', '2017-11-13 03:32:46', 14000024),
	(18000409, '10.74034', '122.9651', '2017-11-13 03:33:06', 14000024),
	(18000410, '10.74034', '122.9651', '2017-11-13 03:33:26', 14000024),
	(18000411, '10.74034', '122.9651', '2017-11-13 03:33:46', 14000024),
	(18000412, '10.67776', '122.9621', '2017-11-13 10:03:19', 14000026),
	(18000413, '10.67664', '122.9597', '2017-11-13 10:03:39', 14000026),
	(18000414, '10.67770', '122.9622', '2017-11-13 10:04:03', 14000026),
	(18000415, '10.67789', '122.9621', '2017-11-13 10:04:19', 14000026),
	(18000416, '10.67759', '122.9621', '2017-11-13 10:04:39', 14000026),
	(18000417, '10.67776', '122.9621', '2017-11-13 10:04:59', 14000026),
	(18000418, '10.67776', '122.9621', '2017-11-13 10:05:20', 14000026),
	(18000419, '10.67776', '122.9621', '2017-11-13 10:05:40', 14000026),
	(18000420, '10.67759', '122.9621', '2017-11-13 10:06:00', 14000026),
	(18000421, '10.67803', '122.9619', '2017-11-13 10:06:20', 14000026),
	(18000422, '10.67776', '122.9621', '2017-11-13 10:06:40', 14000026),
	(18000423, '10.67776', '122.9621', '2017-11-13 10:07:00', 14000026),
	(18000424, '37.42199', '-122.084', '2017-11-14 00:10:11', 14000027),
	(18000425, '12.96504', '10.74035', '2017-11-14 00:10:30', 14000027),
	(18000426, '12.96504', '10.74035', '2017-11-14 00:10:43', 14000027),
	(18000427, '12.96504', '10.74035', '2017-11-14 00:15:02', 14000027),
	(18000428, '12.96504', '10.74035', '2017-11-14 00:15:45', 14000027),
	(18000429, '12.96504', '10.74035', '2017-11-14 00:15:55', 14000027),
	(18000430, '12.96504', '10.74035', '2017-11-14 00:16:06', 14000027),
	(18000431, '12.96479', '10.73969', '2017-11-14 00:16:56', 14000027),
	(18000432, '10.74034', '122.9651', '2017-11-14 00:27:47', 14000028),
	(18000433, '10.74034', '122.9651', '2017-11-14 00:28:08', 14000028),
	(18000434, '10.74034', '122.9651', '2017-11-14 00:28:28', 14000028),
	(18000435, '10.74034', '122.9651', '2017-11-14 00:28:48', 14000028),
	(18000436, '10.67776', '122.9621', '2017-11-14 13:36:07', 14000029),
	(18000437, '10.67775', '122.9621', '2017-11-14 13:36:27', 14000029),
	(18000438, '10.67776', '122.9621', '2017-11-14 13:36:44', 14000029),
	(18000439, '10.67776', '122.9621', '2017-11-14 13:37:06', 14000029),
	(18000440, '10.67776', '122.9621', '2017-11-14 13:42:07', 14000030),
	(18000441, '10.67776', '122.9621', '2017-11-14 13:42:27', 14000030),
	(18000442, '10.67775', '122.9621', '2017-11-14 13:42:47', 14000030),
	(18000443, '10.67776', '122.9621', '2017-11-14 13:43:07', 14000030),
	(18000444, '10.67776', '122.9621', '2017-11-14 13:43:27', 14000030),
	(18000445, '10.67776', '122.9621', '2017-11-14 13:43:47', 14000030),
	(18000446, '10.67776', '122.9621', '2017-11-14 13:44:07', 14000030),
	(18000447, '10.67770', '122.9622', '2017-11-14 13:44:27', 14000030),
	(18000448, '10.67776', '122.9621', '2017-11-14 13:44:47', 14000030),
	(18000449, '10.67776', '122.9621', '2017-11-14 13:45:07', 14000030),
	(18000450, '10.67776', '122.9621', '2017-11-14 13:45:28', 14000030),
	(18000451, '10.67776', '122.9621', '2017-11-14 14:20:00', 14000031),
	(18000452, '10.67776', '122.9621', '2017-11-14 14:20:20', 14000031),
	(18000453, '10.67776', '122.9621', '2017-11-14 14:20:40', 14000031);
...
CREATE TABLE IF NOT EXISTS `tbl_sales` (
  ...
  KEY `order_id` (`order_id`)
) ENGINE=InnoDB AUTO_INCREMENT=19000056 DEFAULT CHARSET=latin1;

-- Dumping data for table db_binalbagancommercial.tbl_sales: ~77 rows (approximately)
...
INSERT INTO `tbl_sales` (`sales_id`, `sales_datestamp`, `sales_timestamp`, `emp_id`, `cust_id`, `receive_datetimestamp`, `sales_type`, `order_id`) VALUES
	...
	(19000020, '2017-10-23', '11:18:33', 0, 110000011, '2017-11-13 02:29:21', 2, 9000014),
	...
	(19000024, '2017-10-23', '11:30:06', 0, 110000011, '2017-11-13 02:29:11', 2, 9000017),
	(19000025, '2017-10-24', '16:05:20', 0, 110000011, '2017-11-13 02:20:01', 2, 9000018),
	(19000026, '2017-10-24', '16:05:20', 0, 110000011, '2017-11-13 02:20:01', 2, 9000018),
	(19000027, '2017-10-24', '16:05:20', 0, 110000011, '2017-11-13 02:20:01', 2, 9000018),
	(19000028, '2017-10-24', '16:05:20', 0, 110000011, '2017-11-13 02:20:01', 2, 9000018),
	(19000029, '2017-10-24', '16:05:20', 0, 110000011, '2017-11-13 02:20:01', 2, 9000018),
	(19000030, '2017-10-24', '16:05:20', 0, 110000011, '2017-11-13 02:20:01', 2, 9000018),
	(19000031, '2017-10-24', '16:05:20', 0, 110000011, '2017-11-13 02:20:01', 2, 9000018),
	(19000032, '2017-10-24', '16:05:20', 0, 110000011, '2017-11-13 02:20:01', 2, 9000018),
	(19000033, '2017-10-24', '16:05:20', 0, 110000011, '2017-11-13 02:20:01', 2, 9000018),
	(19000034, '2017-10-24', '16:05:21', 0, 110000011, '2017-11-13 02:20:01', 2, 9000018),
	(19000035, '2017-10-24', '16:05:22', 0, 110000011, '2017-11-13 02:20:01', 2, 9000018),
	(19000036, '2017-10-24', '16:05:22', 0, 110000011, '2017-11-13 02:20:01', 2, 9000018),
	(19000037, '2017-10-24', '16:05:22', 0, 110000011, '2017-11-13 02:20:01', 2, 9000018),
	(19000038, '2017-10-24', '16:05:22', 0, 110000011, '2017-11-13 02:20:01', 2, 9000018),
	(19000039, '2017-10-24', '16:05:22', 0, 110000011, '2017-11-13 02:20:01', 2, 9000018),
	(19000040, '2017-10-24', '16:05:22', 0, 110000011, '2017-11-13 02:20:01', 2, 9000018),
	(19000041, '2017-11-06', '14:23:54', 80000002, 0, '2017-11-06 14:23:54', 2, 0),
	(19000042, '2017-11-13', '02:15:25', 0, 110000011, '0000-00-00 00:00:00', 2, 9000021),
	(19000043, '2017-11-13', '02:20:01', 0, 110000011, '0000-00-00 00:00:00', 2, 9000018),
	(19000044, '2017-11-13', '02:28:28', 0, 110000011, '0000-00-00 00:00:00', 2, 9000020),
	(19000045, '2017-11-13', '02:29:11', 0, 110000011, '0000-00-00 00:00:00', 2, 9000017),
	(19000046, '2017-11-13', '02:29:21', 0, 110000011, '0000-00-00 00:00:00', 2, 9000014),
	(19000047, '2017-11-13', '02:50:16', 0, 110000011, '0000-00-00 00:00:00', 2, 9000022),
	(19000048, '2017-11-13', '03:34:12', 0, 110000011, '2017-11-13 03:34:14', 2, 9000023),
	(19000049, '2017-11-13', '03:34:14', 0, 110000011, '0000-00-00 00:00:00', 2, 9000023),
	(19000050, '2017-11-13', '10:07:20', 0, 110000011, '0000-00-00 00:00:00', 2, 9000024),
	(19000051, '2017-11-14', '00:17:56', 0, 110000011, '0000-00-00 00:00:00', 2, 9000025),
	(19000052, '2017-11-14', '00:29:02', 0, 110000011, '0000-00-00 00:00:00', 2, 9000026),
	(19000053, '2017-11-14', '13:37:22', 0, 110000011, '0000-00-00 00:00:00', 2, 9000027),
	(19000054, '2017-11-14', '13:45:51', 0, 110000011, '0000-00-00 00:00:00', 2, 9000028),
	(19000055, '2017-11-14', '14:20:52', 0, 110000011, '0000-00-00 00:00:00', 2, 9000029);
...
CREATE TABLE IF NOT EXISTS `tbl_sales_list` (
  ...
  KEY `prd_id` (`prd_id`),
  KEY `sales_id` (`sales_id`)
) ENGINE=InnoDB AUTO_INCREMENT=20000081 DEFAULT CHARSET=latin1;

-- Dumping data for table db_binalbagancommercial.tbl_sales_list: ~93 rows (approximately)
...
INSERT INTO `tbl_sales_list` (`sales_list_id`, `prd_id`, `prd_qty`, `sales_id`, `prd_price`) VALUES
	...
	(20000046, 16000000, 20, 19000025, 278.55),
	(20000047, 16000000, 20, 19000026, 278.55),
	(20000048, 16000000, 20, 19000028, 278.55),
	(20000049, 16000000, 20, 19000029, 278.55),
	(20000050, 16000000, 20, 19000032, 278.55),
	(20000051, 16000000, 20, 19000031, 278.55),
	(20000052, 16000000, 20, 19000030, 278.55),
	(20000053, 16000000, 20, 19000027, 278.55),
	(20000054, 16000000, 20, 19000033, 278.55),
	(20000055, 16000000, 20, 19000034, 278.55),
	(20000056, 16000000, 20, 19000035, 278.55),
	(20000057, 16000000, 20, 19000036, 278.55),
	(20000058, 16000000, 20, 19000037, 278.55),
	(20000059, 16000000, 20, 19000038, 278.55),
	(20000060, 16000000, 20, 19000039, 278.55),
	(20000061, 16000000, 20, 19000040, 278.55),
	(20000062, 6, 4, 19000041, 180.00),
	(20000063, 16000003, 2, 19000041, 84.99),
	(20000064, 16000002, 20, 19000042, 300.45),
	(20000065, 16000000, 20, 19000043, 278.55),
	(20000066, 16000001, 20, 19000044, 160.53),
	(20000067, 16000002, 20, 19000044, 300.45),
	(20000068, 16000000, 20, 19000045, 278.55),
	(20000069, 16000003, 20, 19000046, 84.99),
	(20000070, 16000001, 20, 19000046, 160.53),
	(20000071, 16000002, 5, 19000046, 300.45),
	(20000072, 16000002, 20, 19000047, 300.45),
	(20000073, 16000002, 20, 19000048, 300.45),
	(20000074, 16000002, 20, 19000049, 300.45),
	(20000075, 16000002, 20, 19000050, 300.45),
	(20000076, 16000002, 20, 19000051, 300.45),
	(20000077, 16000002, 20, 19000052, 300.45),
	(20000078, 16000002, 20, 19000053, 300.45),
	(20000079, 16000001, 35, 19000054, 160.53),
	(20000080, 16000001, 35, 19000055, 160.53);
